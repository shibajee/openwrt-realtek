...
/* SoC identifier */
#define SOC_ID_RTL8196E			0x80000000
...
/* Interrupt bits */
#define RTL8196E_INTCTL_IRQ_USB				BIT(16)	/* OR 17? */
#define RTL8196E_INTCTL_IRQ_TC1				BIT(15)
#define RTL8196E_INTCTL_IRQ_TC0				BIT(14)
#define RTL8196E_INTCTL_IRQ_GDMA			BIT(11)
#define RTL8196E_INTCTL_IRQ_PCIE			BIT(10)
#define RTL8196E_INTCTL_IRQ_GPIO			BIT(9)
#define RTL8196E_INTCTL_IRQ_SWCORE			BIT(8)
#define RTL8196E_INTCTL_IRQ_UART0			BIT(7)

/* REALTEK_SYS_REG_BOOTSTRAP */
#define RTL8196E_BOOTSTRAP_AP_ROUTER_MODE		BIT(20)

#define RTL8196E_BOOTSTRAP_CPU_FREQ_DIV			BIT(19)

#define RTL8196E_BOOTSTRAP_CPU_FREQ_SHIFT		14
#define RTL8196E_BOOTSTRAP_CPU_FREQ_MASK		0x7

#define RTL8196E_BOOTSTRAP_SDRAM_CLK_SEL_SHIFT		10
#define RTL8196E_BOOTSTRAP_SDRAM_CLK_SEL_MASK		0x7

#define RTL8196E_BOOTSTRAP_CLKLX_FROM_CLKM		BIT(7)

#define RTL8196E_BOOTSTRAP_BOOT_SEL			BIT(2)

/* REALTEK_SYS_REG_CLK_MANAGE */
#define RTL8196E_SYS_CLK_USB_HOST_EN			BIT(17)
#define RTL8196E_SYS_CLK_PCIE0_DEV_RST_L		BIT(12)
#define RTL8196E_SYS_CLK_PCIE0_EN			BIT(11)

/* REALTEK_SYS_REG_GPIO_MUX */
#define RTL8196E_GPIO_MUX_PCIE_RST			BIT(23)

#define RTL8196E_GPIO_MUX_UART				BIT(22)

#define RTL8196E_GPIO_MUX_JTAG_SHIFT			20
#define RTL8196E_GPIO_MUX_JTAG_MASK			0x3

#define RTL8196E_GPIO_MUX_MEM_SHIFT			18
#define RTL8196E_GPIO_MUX_MEM_MASK			0x3

#define RTL8196E_GPIO_MUX_GPIOC0_SHIFT			12
#define RTL8196E_GPIO_MUX_GPIOC0_MASK			0x3

#define RTL8196E_GPIO_MUX_RESET_SHIFT			10
#define RTL8196E_GPIO_MUX_RESET_MASK			0x3

#define RTL8196E_GPIO_MUX_PORT4_SHIFT			8
#define RTL8196E_GPIO_MUX_PORT4_MASK			0x3

#define RTL8196E_GPIO_MUX_PORT3_SHIFT			6
#define RTL8196E_GPIO_MUX_PORT3_MASK			0x3

#define RTL8196E_GPIO_MUX_PORT2_SHIFT			4
#define RTL8196E_GPIO_MUX_PORT2_MASK			0x3

#define RTL8196E_GPIO_MUX_PORT1_SHIFT			2
#define RTL8196E_GPIO_MUX_PORT1_MASK			0x3

#define RTL8196E_GPIO_MUX_PORT0_SHIFT			0
#define RTL8196E_GPIO_MUX_PORT0_MASK			0x3

/* REALTEK_INTCTL_REG_IRR0 */
#define RTL8196E_INTCTL_IRR0_UART_SHIFT			28
#define RTL8196E_INTCTL_IRR0_UART_MASK			0x0f

/* REALTEK_INTCTL_REG_IRR1 */
#define RTL8196E_INTCTL_IRR1_TC1_SHIFT			28
#define RTL8196E_INTCTL_IRR1_TC1_MASK			0x0f

#define RTL8196E_INTCTL_IRR1_TC0_SHIFT			24
#define RTL8196E_INTCTL_IRR1_TC0_MASK			0x0f

#define RTL8196E_INTCTL_IRR1_GDMA_SHIFT			12
#define RTL8196E_INTCTL_IRR1_GDMA_MASK			0x0f

#define RTL8196E_INTCTL_IRR1_PCIE_SHIFT			8
#define RTL8196E_INTCTL_IRR1_PCIE_MASK			0x0f

#define RTL8196E_INTCTL_IRR1_GPIO_SHIFT			4
#define RTL8196E_INTCTL_IRR1_GPIO_MASK			0x0f

#define RTL8196E_INTCTL_IRR1_SWCORE_SHIFT		0
#define RTL8196E_INTCTL_IRR1_SWCORE_MASK		0x0f

/* REALTEK_INTCTL_REG_IRR2 */
#define RTL8196E_INTCTL_IRR2_USB_HOST_SHIFT		0
#define RTL8196E_INTCTL_IRR2_USB_HOST_MASK		0x0f

/* REALTEK_TC_REG_DATA / REALTEK_TC_REG_COUNT */
#define RTL8196E_TC_DATA_REVA_SHIFT			8
#define RTL8196E_TC_DATA_REVA_MASK			0xffffff

#define RTL8196E_TC_DATA_REVB_SHIFT			4
#define RTL8196E_TC_DATA_REVB_MASK			0xffffffff
