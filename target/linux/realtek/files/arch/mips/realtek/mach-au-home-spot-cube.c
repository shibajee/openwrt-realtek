...
static void __init au_home_spot_cube_init(void)
{
	...
	realtek_set_gpio_mux(
		RTL8196E_GPIO_MUX_PCIE_RST |
		(RTL8196E_GPIO_MUX_PORT0_MASK << RTL8196E_GPIO_MUX_PORT0_SHIFT) |
		(RTL8196E_GPIO_MUX_PORT4_MASK << RTL8196E_GPIO_MUX_PORT4_SHIFT),
		(RTL8196E_GPIO_MUX_PORT2_MASK << RTL8196E_GPIO_MUX_PORT2_SHIFT) |
		(RTL8196E_GPIO_MUX_PORT3_MASK << RTL8196E_GPIO_MUX_PORT3_SHIFT) |
		(RTL8196E_GPIO_MUX_RESET_MASK << RTL8196E_GPIO_MUX_RESET_SHIFT) |
		(RTL8196E_GPIO_MUX_GPIOC0_MASK << RTL8196E_GPIO_MUX_GPIOC0_SHIFT) |
		(RTL8196E_GPIO_MUX_JTAG_MASK << RTL8196E_GPIO_MUX_JTAG_SHIFT));
}
